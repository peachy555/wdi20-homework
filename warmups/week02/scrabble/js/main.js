...
var scrabble = {
  ...
  score: function ( word ) {
    ...
    for( var i = 0; i < word.length; i++ ){
      ...
      var letter = word[i];
       ...
       // Iterate over each key, i.e. the scores (1, 2, 3, 4, 5, 8, 10)
  ...
  scoreAlternative: function ( word ) {
    ...
    for (var i = 0; i < word.length; i++) {
      var letter = word[i];
      // No more nested looping! Just use 'letter' directly as the key into our object: the value is the score
...
console.log('%c' + scrabble.score( "cabbage"), "font-size: 16pt; color: red;" ); // CSS in your console.log!


console.log('scrabble.scoreAlternative("cabbage"), expecting: 14');
console.log('%c' + scrabble.scoreAlternative( "cabbage"), "font-size: 16pt; color: red;" );
