...
// We need to wrap our code in the jQuery $(document).ready() event handler, beacause a lot
// of the code needs to access DOM elements, so we have to wait until the page is finished
// loading before our code can run
$(document).ready(function () {
  ...
  var putWord = function() {
    ...
    $div.css({
      ...
      // backgroundImage: 'url( http://fillmurray.com/300/200 )',
    });
