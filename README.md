# WDI-20 ([General Assembly, Sydney](https://generalassemb.ly/sydney))
##Homework Repository
...
- **Clone your forked repository to your computer**
    ...
    + Make sure you're browser is open to **your** forked version of this repository on Github (eg [http://github.com/{{YOUR_USERNAME}}/wdi20-homework](http://hithub.com/{{YOUR_USERNAME}}/wdi20-homework)).
...
- **Add an upstream remote repository**
    ...
    + `cd wdi20-homework`
    + `git remote add upstream https://github.com/textchimp/wdi20-homework`
...
2. Go to your local homework repo (eg, `cd Projects/general-assembly/wdi20-homework`);
...
- **Once you're finished, submit a pull request for me to accept your homework**
    + Navigate to your forked version of this repository on Github (eg [https://github.com/{{YOUR_USERNAME_HERE}}/wdi20-homework](https://github.com/{{YOUR_USERNAME_HERE}}/wdi20-homework)).
